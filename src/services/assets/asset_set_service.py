...
def create_asset_set_tools(
    ...
    async def create_asset_set(
        ...
        asset_set_type_enum = resolve_enum(
            AssetSetTypeEnum.AssetSetType, asset_set_type, "asset_set_type"
        )
        status_enum = resolve_enum(AssetSetStatusEnum.AssetSetStatus, status, "status")
    ...
    async def update_asset_set(
        ...
        status_enum = (
            resolve_enum(AssetSetStatusEnum.AssetSetStatus, status, "status")
            if status
            else None
        )
