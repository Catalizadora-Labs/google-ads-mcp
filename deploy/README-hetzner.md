...
- **API v24** (upstream sigue en v20, que Google bloqueó en jun-2026; v21 en ago; v22 caerá). `sed googleads.vN`
  en `src/**.py` + `src/sdk_client.py`. v23 y v24 importan limpio (medido 16-sep-2026).
...
Cuando Google bloquee v24: subir la lib (`uv lock --upgrade-package google-ads`), mirar qué versiones trae
